...
dado_teste = np.array([4, 5, 67, 89, 9])  # Gera [4, 5, 67, 89, 9], mas no formato array de 1 dimensão.
...
dado_teste = np.array([4, 5, 9],
                        ...
                        [4, 7, 0])
print(dado_teste)
print(dado_teste.ndim) # Quantidade de dimensões do dado
print(dado_teste.size) # Quantidade de dados
print(dado_teste.shape) # Quantidade de linhas e colunas
```  
